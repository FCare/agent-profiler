            ...
            "intents": [
                {
                    ...
                    "description": "Recherche dans la mémoire personnelle de l'utilisateur : habitudes, préférences, goûts, lieux",
                    "examples": [
                        "Quels sont mes lieux habituels ?",
                        "Est-ce que j'aime le jazz ?",
                        "Qu'est-ce que tu sais de moi ?",
                        "Tu sais quoi sur moi ?",
                        "T'as quoi dans ta mémoire sur moi ?",
                        "Dis-moi ce que tu sais sur moi",
                        "Quelles sont mes préférences musicales ?",
                        "Rappelle-moi mes équipes de foot préférées",
                        "Est-ce que j'ai des allergies alimentaires ?",
                        "Quels sont mes restaurants favoris ?",
                        "Mes habitudes de sport",
                        "Qu'est-ce que j'aime comme films ?",
                        "Où est-ce que j'habite d'habitude ?",
                    ],
                    "payload": {"query": "{query}"},
                    "write_topic": search_topic,
                },
                {
                    "name": "profiler.delete",
                    "description": "Supprime un fait mémorisé sur l'utilisateur",
                    "examples": [
                        "Oublie ce que tu sais sur moi",
                        "Supprime mes données personnelles",
                        "Efface mes habitudes de sport",
                        "Je ne veux plus que tu te souviennes de mes goûts musicaux",
                        "Supprime mon profil",
                        "Oublie mes préférences de cuisine",
                        "Tu n'as plus besoin de savoir où j'habite",
                        "Efface les données sur ma musique préférée",
                        "Je ne m'intéresse plus au retro gaming",
                        "Supprime tout ce que tu sais sur mes voyages",
                    ],
                    "payload": {"query": "{query}"},
